  ...
  async listAll(): Promise<UnidadeListaItem[]> {
    return this.prisma.$queryRaw<UnidadeListaItem[]>(Prisma.sql`
      SELECT
        ...
        uf.cep,
        uf.endereco,
        uf.numero_endereco AS "numeroEndereco",
        uf.bairro,
        uf.cidade,
        uf.estado,
        uf.complemento,
        uf.referencia,
        uf.sla_corretiva_horas AS "slaCorretivaHoras",
        uf.sla_preventiva_horas AS "slaPreventivaHoras",
        uf.sla_preditiva_horas AS "slaPreditivaHoras",
