...
export default function AssetsPage() {
  ...
  const stats = {
    ...
    ativos: mockAssets.filter((a) => a.status === 'ATIVO').length,
    emManutencao: mockAssets.filter((a) => a.status === 'EM_MANUTENCAO').length,
    inativos: mockAssets.filter((a) => a.status === 'INATIVO' || a.status === 'DESATIVADO').length,
  }
