...
export const SIDEBAR_NAVIGATION = [
  {
    title: 'Principal',
    items: [
      { title: 'Início', url: '/', icon: 'Home', screen: 'home' },
      { title: 'Ordens de Serviço', url: '/ordens', icon: 'ClipboardList', screen: 'ordens-lista' },
      { title: 'Ativos', url: '/ativos', icon: 'Package', screen: 'ativos-lista' },
    ],
  },
  {
    title: 'Gestão',
    items: [
      { title: 'Usuários', url: '/usuarios', icon: 'Users', screen: 'usuarios' },
      { title: 'Unidades', url: '/unidades', icon: 'Building2', screen: 'unidades' },
      { title: 'Permissões', url: '/permissoes', icon: 'Shield', screen: 'permissoes' },
    ],
  },
  {
    title: 'Análises',
    items: [
      { title: 'Dashboard', url: '/dashboard', icon: 'BarChart3', screen: 'dashboard' },
      { title: 'Relatórios', url: '/relatorios', icon: 'FileText', screen: 'relatorios' },
      { title: 'Auditoria', url: '/auditoria', icon: 'History', screen: 'auditoria' },
    ],
  },
  {
    title: 'Sistema',
    items: [
      { title: 'Notificações', url: '/notificacoes', icon: 'Bell', screen: 'notificacoes' },
      { title: 'Integrações', url: '/integracoes', icon: 'Plug', screen: 'integracoes' },
      { title: 'IoT', url: '/iot', icon: 'Cpu', screen: 'iot' },
      { title: 'Configurações', url: '/configuracoes', icon: 'Settings', screen: 'configuracoes' },
    ],
  },
]
